...
# ========== modify for each run ==========
run_id = "03" 
# Same as run01 except the bash submission script allocated 64G in memory and 9h in time.

output_dir = "output/Unet/binary/t1ce/"
output_dir_model = "model/Unet/binary/t1ce/"
output_nii = "output/nii_output/Unet/binary/t1ce/run" + str(run_id) + "/"

type_run = "Unet_binary_t1ce"
