...
# ========== modify for each run ==========
run_id = "01" 
# Copied from t1 run01. Everything is the same except image modality is t2 instead of t1.

output_dir = "output/Unet/binary/t2/"
output_dir_model = "model/Unet/binary/t2/"
output_nii = "output/nii_output/Unet/binary/t2/run" + str(run_id) + "/"

type_run = "Unet_binary_t2"
