...
# ========== modify for each run ==========
run_id = "25" 
#24: Changes from run24:
# 1) Using the full set of images and running for 300 epochs.

output_dir = "output/Unet/binary/"
output_dir_model = "model/Unet/binary/"
output_nii = "output/nii_output/Unet/binary/run" + str(run_id) + "/"

type_run = "Unet_binary"
