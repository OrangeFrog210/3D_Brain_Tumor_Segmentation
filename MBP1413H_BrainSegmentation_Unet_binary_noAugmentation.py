...
# ========== modify for each run ==========
run_id = "02" 
#02: Same as run01 of no_augmentation, but
# 1) The submission sbatch uses: 64G and 9h time allocation

output_dir = "output/Unet/binary/no_augmentation/"
output_dir_model = "model/Unet/binary/no_augmentation/"
output_nii = "output/nii_output/Unet/binary/no_augmentation/run" + str(run_id) + "/"

type_run = "Unet_binary_noAugmentation"
